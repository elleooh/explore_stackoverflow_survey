...
def print_chi2_test_result(df, col_ind, col_res, res_val_lst):
    ...
    print('The p_value for chi-square test for independence between {0} and {1} is {2:.2f}'\
    	.format(col_ind, col_res, p_value))
...
def check_significance(df, col_ind, col_res, val, p_0=0.5, sig_level=0.05):
    ...
    _, pval = proportions_ztest(count, nobs, p_0, alternative)
